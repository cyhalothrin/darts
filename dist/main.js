...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Dartboard = __webpack_require__(/*! ./Dartboard */ 159);
	
	var _Dartboard2 = _interopRequireDefault(_Dartboard);
	
	var _global = __webpack_require__(/*! ../css/global.css */ 164);
	...
	var DartsApp = (function (_React$Component) {
	  _inherits(DartsApp, _React$Component);
	
	  function DartsApp() {
	    _classCallCheck(this, DartsApp);
	
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DartsApp).call(this));
	  ...
	  _createClass(DartsApp, [{
	    key: 'addStep',
	    value: function addStep(point) {
	      var stepsCount = this.state.stepsCount;
	      var player1Steps = [].concat(_toConsumableArray(this.state.player1Steps));
	      var player2Steps = [].concat(_toConsumableArray(this.state.player2Steps));
	      if (stepsCount < 3) {
	    ...
	    key: 'removeLastStep',
	    value: function removeLastStep() {}
	  }, {
	    key: 'render',
	    value: function render() {
	      var value = this.state.value;
	      var player1Point = this.state.player1Steps.reduce(function (sum, point) {
	        return sum + point;
	      }, 0);
	      var player2Point = this.state.player2Steps.reduce(function (sum, point) {
	        return sum + point;
	      }, 0);
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'button',
	          { onClick: this.addStep.bind(this, 10) },
	          '+'
	        ),
	        _react2.default.createElement(
	          'div',
	          null,
	          this.state.player1Steps
	        ),
	        _react2.default.createElement(
	          'div',
	          null,
	          this.state.player2Steps
	        ),
	        _react2.default.createElement(
	          'div',
	          null,
	        ...
	        _react2.default.createElement(_Dartboard2.default, { add: this.addStep.bind(this) })
	      );
	    }
	  }]);
	...
	_reactDom2.default.render(_react2.default.createElement(DartsApp, null), document.getElementById('root'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Sector = __webpack_require__(/*! ./Sector */ 160);
	
	var _Sector2 = _interopRequireDefault(_Sector);
	
	var _PolarCoords = __webpack_require__(/*! ./PolarCoords */ 161);
	
	var _PolarCoords2 = _interopRequireDefault(_PolarCoords);
	
	var _sector = __webpack_require__(/*! ../css/sector.css */ 168);
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'g',
	          null,
	          _react2.default.createElement('circle', { cx: radius, cy: radius, r: radius, className: _sector2.default.board }),
	          _react2.default.createElement('circle', { cx: radius, cy: radius, r: 0.0857 * radius, className: _sector2.default.xxOdd }),
	          _react2.default.createElement('circle', { cx: radius, cy: radius, r: 0.0429 * radius, className: _sector2.default.xxEven }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _RingSector = __webpack_require__(/*! ./RingSector */ 162);
	  ...
	  _createClass(Sector, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'g',
	        { className: 'sector' },
	        _react2.default.createElement(_RingSector2.default, _extends({ r1: r2, r2: r5, className: x1ClassName }, options)),
	        _react2.default.createElement(_RingSector2.default, _extends({ r1: r, r2: r2, className: xxClassName }, options)),
	        _react2.default.createElement(_RingSector2.default, _extends({ r1: r3, r2: r4, className: xxClassName }, options)),
	...
	var RingSector = (function (_Component) {
	  ...
	  _createClass(RingSector, [{
	    ...
	    value: function path(r1, r2, angle1, angle2) {
	      ...
	      var arc1 = this.arc(r1, this.xy(r1, angle2), CLOCKWISE);
	      var xy2 = this.xy(r2, angle2);
	      var arc2 = this.arc(r2, this.xy(r2, angle1), COUNTERCLOCK);
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement('path', { d: path, className: this.props.className });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../../~/css-loader?modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./../../~/postcss-loader!./global.css */ 165);
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./../../node_modules/postcss-loader/index.js!./global.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./../../node_modules/postcss-loader/index.js!./global.css");
...
/* 165 */
/*!***************************************************************************************************************************************!*\
  !*** ./~/css-loader?modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./~/postcss-loader!./src/css/global.css ***!
  \***************************************************************************************************************************************/
/***/ function(module, exports, __webpack_require__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../../~/css-loader?modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./../../~/postcss-loader!./sector.css */ 169);
	if(typeof content === 'string') content = [[module.id, content, '']];
	// add the styles to the DOM
	var update = __webpack_require__(/*! ./../../~/style-loader/addStyles.js */ 167)(content, {});
	if(content.locals) module.exports = content.locals;
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./../../node_modules/postcss-loader/index.js!./sector.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./../../node_modules/postcss-loader/index.js!./sector.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/* 169 */
/*!***************************************************************************************************************************************!*\
  !*** ./~/css-loader?modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./~/postcss-loader!./src/css/sector.css ***!
  \***************************************************************************************************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".sector__x1Even___3ZxYF, .sector__x1Odd___1moCO, .sector__xxEven___3nBjs, .sector__xxOdd___3xZYA {\r\n  -webkit-transition: fill 200ms;\r\n  transition: fill 200ms;\r\n  cursor: pointer;\r\n}\r\n\r\n.sector__xxEven___3nBjs, .sector__xxOdd___3xZYA {\r\n  stroke: white;\r\n  stroke-width: 2;\r\n}\r\n\r\n.sector__x1Even___3ZxYF:hover, .sector__x1Odd___1moCO:hover, .sector__xxEven___3nBjs:hover, .sector__xxOdd___3xZYA:hover {\r\n  fill: #FFDC00;\r\n}\r\n\r\n.sector__x1Even___3ZxYF {\r\n  fill: black;\r\n}\r\n\r\n.sector__x1Odd___1moCO {\r\n  fill: white;\r\n}\r\n\r\n.sector__xxEven___3nBjs {\r\n  fill: red;\r\n}\r\n\r\n.sector__xxOdd___3xZYA {\r\n  fill: green;\r\n}\r\n\r\n.sector__point___2B2Il {\r\n  dominant-baseline: central;\r\n  text-anchor: middle;\r\n  font-size: 20;\r\n  font-family: 'Arial';\r\n  fill: white;\r\n}\r\n\r\n.sector__board___LeoIp {\r\n  fill: black;\r\n}\r\n", ""]);
	
	// exports
	exports.locals = {
		"x1Even": "sector__x1Even___3ZxYF",
		"x1Odd": "sector__x1Odd___1moCO",
		"xxEven": "sector__xxEven___3nBjs",
		"xxOdd": "sector__xxOdd___3xZYA",
		"point": "sector__point___2B2Il",
		"board": "sector__board___LeoIp"
	};
